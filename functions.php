 ...
 * @var string
 */
define( 'PRIMER_CHILD_VERSION', '1.0.3' );
...
if ( class_exists( 'Reseller_Store\Plugin' ) && rstore_is_setup() ) {
	...
	require_once __DIR__ . '/inc/turnkey.php';
 ...
 * @since  1.0.0
 */
function turnkey_move_elements() {
 ...
 * @return string
 */
function turnkey_hero_image_selector() {

	return '.hero';

}
add_filter( 'primer_hero_image_selector', 'turnkey_hero_image_selector' );
 ...
 * @return array
 */
function turnkey_custom_logo_args( $args ) {
...
add_filter( 'primer_custom_logo_args', 'turnkey_custom_logo_args' );
 ...
 * @return array
 */
function turnkey_sidebars( $sidebars ) {

	$sidebars['footer-4'] = array(
		'name'          => esc_html__( 'Footer 4', 'turnkey' ),
		'description'   => esc_html__( 'This sidebar is the fourth column of the footer widget area.', 'turnkey' ),
...
add_filter( 'primer_sidebars', 'turnkey_sidebars' );
...
add_filter( 'primer_fonts', 'turnkey_fonts' );
 ...
 * @return array
 */
function turnkey_font_types( $font_types ) {
...
add_filter( 'primer_font_types', 'turnkey_font_types' );
...
add_action( 'wp_enqueue_scripts', 'turnkey_scripts' );
